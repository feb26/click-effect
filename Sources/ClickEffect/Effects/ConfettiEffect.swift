...
struct ConfettiEffect: ClickEffect {
    var baseLifetime: Float = 0.55
    var baseVelocity: CGFloat = 100
    ...
    func play(at point: CGPoint, in hostLayer: CALayer, config: EffectConfig) {
        ...
        cell.velocityRange = 50 * config.sizeScale
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + Double(baseLifetime) / speed + 0.2) {
